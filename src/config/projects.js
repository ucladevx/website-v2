...
export default {
  winter20: [
    ...
    {
      name: 'Twyne',
      tagline: 'Interact freely',
      description:
        'Wearables are the future. Twyne helps users interact with the world through simple and natural motions.',
      notion:
        'https://www.notion.so/twyne/Twyne-df5ee31c9ab14e178ae37078086e50fc',
      logo: twyneLogo
    },
    {
      name: 'Twain',
